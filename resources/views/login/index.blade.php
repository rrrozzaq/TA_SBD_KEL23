...
<body style="background-color:#BAD6EB;">
    <div class="container bg-dark"><br>
    <div class="border rounded-3 border-dark">
        <div class="col-md-6 col-md-offset-3">
            <hr>
            <h3 class="text-center">The Tenant's</h3>
            <hr>
            <img src="{{asset('img/sbd2.png')}}" style="display:block;margin-left:auto; margin-right:auto; width:400px; height:300px;">
            @if (session('error'))
